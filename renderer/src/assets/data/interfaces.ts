...
export interface TranslationDict {
  ...
  INSCRIBED_ULTIMATUM_CHALLENGE_SURVIVAL: string
  INSCRIBED_ULTIMATUM_CHALLENGE_EXTERMINATE: string
  INSCRIBED_ULTIMATUM_CHALLENGE_DEFENSE: string
  INSCRIBED_ULTIMATUM_CHALLENGE_CONQUER: string
