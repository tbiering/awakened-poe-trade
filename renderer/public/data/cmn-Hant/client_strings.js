...
export default {
  ...
  INSCRIBED_ULTIMATUM_CHALLENGE: /^挑戰: (.*)$/,
  INSCRIBED_ULTIMATUM_SACRIFICE: /^需求獻祭: (?<item>.*?)(?: x(?<quantity>\d+))?$/,
  INSCRIBED_ULTIMATUM_REWARD: /^獎勵: (.*)$/,
  INSCRIBED_ULTIMATUM_REWARD_DOUBLES_CURRENCY: /^翻倍獻祭的通貨$/,
  INSCRIBED_ULTIMATUM_REWARD_DOUBLES_DIVINATION_CARDS: /^翻倍獻祭的命運卡$/,
  INSCRIBED_ULTIMATUM_REWARD_MIRRORED_COPY: /^物品和複製品$/,
  INSCRIBED_ULTIMATUM_CHALLENGE_SURVIVAL: '存活',
  INSCRIBED_ULTIMATUM_CHALLENGE_EXTERMINATE: '擊敗數波怪物',
  INSCRIBED_ULTIMATUM_CHALLENGE_DEFENSE: '保護神壇',
  INSCRIBED_ULTIMATUM_CHALLENGE_CONQUER: '站在符文上',
  VESTIGIAL_NAME: /^殘存 (.*)$/,
