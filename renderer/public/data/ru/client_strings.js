...
export default {
  ...
  INSCRIBED_ULTIMATUM_CHALLENGE: /^Испытание: (.*)$/,
  INSCRIBED_ULTIMATUM_SACRIFICE: /^Требуется жертвоприношение: (?<item>.*?)(?: x(?<quantity>\d+))?$/,
  INSCRIBED_ULTIMATUM_REWARD: /^Награда: (.*)$/,
  INSCRIBED_ULTIMATUM_REWARD_DOUBLES_CURRENCY: /^Удваивает принесённую в жертву валюту$/,
  INSCRIBED_ULTIMATUM_REWARD_DOUBLES_DIVINATION_CARDS: /^Удваивает принесённые в жертву гадальные карты$/,
  INSCRIBED_ULTIMATUM_REWARD_MIRRORED_COPY: /^Предмет и его зеркальная копия$/,
  INSCRIBED_ULTIMATUM_CHALLENGE_SURVIVAL: 'Выживите',
  INSCRIBED_ULTIMATUM_CHALLENGE_EXTERMINATE: 'Победите волны монстров',
  INSCRIBED_ULTIMATUM_CHALLENGE_DEFENSE: 'Защитите Алтарь',
  INSCRIBED_ULTIMATUM_CHALLENGE_CONQUER: 'Стойте на каменных кругах',
