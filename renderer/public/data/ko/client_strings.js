...
export default {
  ...
  INSCRIBED_ULTIMATUM_CHALLENGE: /^도전: (.*)$/,
  INSCRIBED_ULTIMATUM_SACRIFICE: /^필요한 대가: (?<item>.*?)(?: x(?<quantity>\d+)개)?$/,
  INSCRIBED_ULTIMATUM_REWARD: /^보상: (.*)$/,
  INSCRIBED_ULTIMATUM_REWARD_DOUBLES_CURRENCY: /^소모되는 화폐 2배$/,
  INSCRIBED_ULTIMATUM_REWARD_DOUBLES_DIVINATION_CARDS: /^소모되는 점술 카드 2배$/,
  INSCRIBED_ULTIMATUM_REWARD_MIRRORED_COPY: /^아이템과 복제본$/,
  INSCRIBED_ULTIMATUM_CHALLENGE_SURVIVAL: '살아남기',
  INSCRIBED_ULTIMATUM_CHALLENGE_EXTERMINATE: '몬스터 웨이브 완료하기',
  INSCRIBED_ULTIMATUM_CHALLENGE_DEFENSE: '제단 지키기',
  INSCRIBED_ULTIMATUM_CHALLENGE_CONQUER: '두름돌 안에 서기',
  VESTIGIAL_NAME: /^흔적 (.*)$/,
